...
var DebugSession = (function (_super) {
    ...
    DebugSession.prototype.addBreakpoint = function (location, options) {
        ...
        return this.getCommandOutput(cmd + ' ' + location, null, function (output) {
    ...
    DebugSession.prototype.ignoreBreakpoint = function (breakId, ignoreCount) {
        return this.getCommandOutput("break-after " + breakId + " " + ignoreCount, null, function (output) { return extractBreakpointInfo(output); });
    };
    /**
    ...
    DebugSession.prototype.getStackFrames = function (options) {
        ...
        return this.getCommandOutput(fullCmd, null, function (output) {
            ...
            if (Array.isArray(data)) {
                return data.map(function (frame) { return extractStackFrameInfo(frame); });
            }
            else {
        ...
        return this.getCommandOutput(fullCmd, null, function (output) {
            ...
            if (Array.isArray(output.threads)) {
                ...
                var threads = output.threads.map(function (data) {
                    var thread = extractThreadInfo(data);
...
function extractBreakpointInfo(data) {
    return {
        ...
        func: data.bkpt.func,
        filename: data.bkpt.file || data.bkpt.filename,
